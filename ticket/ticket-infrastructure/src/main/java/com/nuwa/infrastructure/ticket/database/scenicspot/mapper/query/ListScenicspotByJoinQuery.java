...
public class ListScenicspotByJoinQuery extends BaseJoinListQuery<ListScenicspotByJoinQuery> {
    private static final long serialVersionUID = 1L;

    @Override
    public void where(JoinQueryBuilder<ListScenicspotByJoinQuery> wrapper) {
    }
}
