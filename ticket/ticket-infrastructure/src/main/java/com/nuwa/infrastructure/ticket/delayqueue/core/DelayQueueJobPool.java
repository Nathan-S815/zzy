package com.nuwa.infrastructure.ticket.delayqueue.core;

import com.nuwa.infrastructure.ticket.delayqueue.utils.RedissonUtils;
...
public class DelayQueueJobPool {
    ...
    private static final String DELAY_QUEUE_JOB_POOL = "delayQueueJobPoolRedis";
