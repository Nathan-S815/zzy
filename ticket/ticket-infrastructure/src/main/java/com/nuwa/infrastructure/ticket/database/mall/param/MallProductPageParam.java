...
@ApiModel(value = "分页参数")
public class MallProductPageParam extends PageQry<MallProduct> {
    private static final long serialVersionUID = 1L;

    private MallProductPageQry qry;

    public MallProductPageParam(MallProductPageQry qry) {
        super(qry);
        this.qry = qry;
    }
    ...
    public LambdaQueryWrapper<MallProduct> toQueryWrapper() {
        ...
        queryWrapper.eq(true, MallProduct::getAppId, qry.getAppId());
        ...
        queryWrapper.eq(Objects.nonNull(qry.getPublishStatus()),MallProduct::getPublishStatus,qry.getPublishStatus());
        queryWrapper.eq(Objects.nonNull(qry.getClassificationFirstId()),MallProduct::getClassificationFirstId,qry.getClassificationFirstId());
