...
@ApiModel(value = "修改密钥-商户")
@Data
@Slf4j
public class MerchantModifySecretKeyReq {

    private RequestHead head;

    private MerchantModifySecretKeyReq.Body body;
    ...
    public static class Body {
        ...
        @NotNull
        @ApiModelProperty("支付中台商户id")
        private String gatewayMchId;

        @NotNull
        @ApiModelProperty("支付中台密钥")
