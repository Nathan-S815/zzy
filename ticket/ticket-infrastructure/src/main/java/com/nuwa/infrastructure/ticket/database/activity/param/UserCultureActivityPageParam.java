...
public class UserCultureActivityPageParam extends PageQry<CultureActivity> {
    private static final long serialVersionUID = 1L;

    private UserCultureActivityPageQry qry;

    public UserCultureActivityPageParam(UserCultureActivityPageQry qry) {
        super(qry);
        this.qry = qry;
    }
    ...
    public LambdaQueryWrapper<CultureActivity> toQueryWrapper() {
        ...
        queryWrapper.eq(CultureActivity::getAppId, qry.getUserAware().getMchAppId());
        queryWrapper.eq(Objects.nonNull(qry.getCategoryId()), CultureActivity::getCategoryId, qry.getCategoryId());
        queryWrapper.like(Objects.nonNull(qry.getActivityTitle()), CultureActivity::getActivityTitle, qry.getActivityTitle());
