package com.nuwa.infrastructure.ticket.database.mchconfig.param;
...
public class MchAppConfPageParam extends PageQry<MerchantAppBaseConf> {
    ...
    public LambdaQueryWrapper<MerchantAppBaseConf> toQueryWrapper() {
        ...
        queryWrapper.orderByDesc(MerchantAppBaseConf::getDefaultFlag);
        ...
        queryWrapper.eq(Objects.nonNull(qry.getProvinceId()) && !qry.getProvinceId().equals(-1L), MerchantAppBaseConf::getProvinceId, qry.getProvinceId());
        queryWrapper.eq(Objects.nonNull(qry.getCityId()) && !qry.getCityId().equals(-1L), MerchantAppBaseConf::getCityId, qry.getCityId());
