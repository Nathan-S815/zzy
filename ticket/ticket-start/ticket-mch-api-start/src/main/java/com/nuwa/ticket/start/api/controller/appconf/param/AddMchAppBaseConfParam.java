...
@ApiModel(value = "AddMchAppBaseConfParam 添加客户端")
public class AddMchAppBaseConfParam extends NuwaCommand {
    ...
    @ApiModelProperty("应用类型 douyin(抖音小程序) weixin_mini(微信小程序) weixin_mp(微信公众号)")
