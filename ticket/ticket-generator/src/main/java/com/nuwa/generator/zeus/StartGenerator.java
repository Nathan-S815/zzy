...
public class StartGenerator {
    ...
    public static void main(String[] args) {
        generatorEntityAndMapper("one_open_api_record", "id", "ps_", "one");
       // generatorService("one_open_api_record", "id", "ps_", "one");
       // generatorPageQryCO("one_open_api_record", "id", "cn_", "one");
       // generatorPage("one_open_api_record", "id", "cn_", "one");
    }
