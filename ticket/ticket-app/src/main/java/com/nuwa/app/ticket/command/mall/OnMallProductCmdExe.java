...
import com.nuwa.client.ticket.dto.clientobject.mall.OnMallProductCmd;
...
@Slf4j
@Component
public class OnMallProductCmdExe extends AbstractCmdExe<OnMallProductCmd, SingleResponse> {

    @Autowired
    private MallProductService productService;

    @Override
    protected SingleResponse handle(OnMallProductCmd cmd) {
        ...
        LambdaUpdateChainWrapper<MallProduct> lambdaUpdate = productService.lambdaUpdate()
                .set(MallProduct::getPublishStatus, PublishStatusEnum.ON.getCode())
