...
import com.nuwa.client.ticket.dto.clientobject.activity.CreateActivityApplyV2Cmd;
...
@Slf4j
@Component
public class CreateActivityApplyV2CmdExe extends AbstractCmdExe<CreateActivityApplyV2Cmd, SingleResponse> {
    ...
    @Override
    protected SingleResponse handle(CreateActivityApplyV2Cmd cmd) {
