package com.example.mysqldocument;
...
class MysqldocumentApplicationTests {
    ...
    void documentGeneration() {
        ...
        hikariConfig.setJdbcUrl("jdbc:mysql://<HOST>/<DATABASE>?<PARAMS>");
        hikariConfig.setUsername("zzysaas");
        hikariConfig.setPassword("<REDACTED>");
