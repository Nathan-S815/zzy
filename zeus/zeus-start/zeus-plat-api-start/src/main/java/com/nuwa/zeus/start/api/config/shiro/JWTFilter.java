...
import com.nuwa.zeus.start.api.config.shiro.exception.AuthException;
...
public class JWTFilter extends BasicHttpAuthenticationFilter {
    ...
    public static final String JWT_HTTP_HEAD = "Authorization";
    ...
    protected boolean isLoginAttempt(ServletRequest request, ServletResponse response) {
        ...
        String authorization = httpServletRequest.getHeader(JWT_HTTP_HEAD);
        if (StrUtil.isBlankOrUndefined(authorization)) {
            authorization = httpServletRequest.getParameter(JWT_HTTP_HEAD);
        }
