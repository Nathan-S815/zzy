...
import com.nuwa.infrastructure.zeus.database.feedback.param.MerchantProblemFeedbackPageParam;
...
@Slf4j
@Component
public class MerchantProblemFeedbackPageQryExe extends AbstractQryExe<ProblemFeedbackPageQry, SingleResponse<IPage<ProblemFeedback>>> {
    @Autowired
    ...
    protected SingleResponse<IPage<ProblemFeedback>> handle(ProblemFeedbackPageQry cmd) {
        IPage<ProblemFeedback> problemFeedbackIPage = problemFeedbackService.paginateByParam(new MerchantProblemFeedbackPageParam(cmd));
