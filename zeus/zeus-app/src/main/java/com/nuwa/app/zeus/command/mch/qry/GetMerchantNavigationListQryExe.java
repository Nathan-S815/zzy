...
@Slf4j
@Component
public class GetMerchantNavigationListQryExe extends AbstractQryExe<GetMerchantNavigationListQry, SingleResponse<List<GetMerchantNavigationListQryExe.MerchantAppVO>>> {
    ...
    protected SingleResponse<List<MerchantAppVO>> handle(GetMerchantNavigationListQry cmd) {
        List<AppInfo> appInfoList = baseMapperExt.selectUserRootApps(cmd.getUserAware().getMchUserId());
