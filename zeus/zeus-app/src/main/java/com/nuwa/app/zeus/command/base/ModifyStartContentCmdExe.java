...
@Slf4j
@Component
public class ModifyStartContentCmdExe extends AbstractCmdExe<ModifyStartContentCmd, SingleResponse> {

    @Autowired
    private GettingStartedService gettingStartedService;

    @Override
    protected SingleResponse handle(ModifyStartContentCmd cmd) {
