...
package com.nuwa.generator.discovery.config;
...
public class GeneratorConfig {
     ...
     * 是否生成实体类
     */
    private boolean generatorEntity = false;
    /**
     * 是否生成控制器
     */
     ...
     * 是否生成查询PageQry
     */
    private boolean generatorQryPage = false;

    /**
     * 是否生成查询CO
     */
    private boolean generatorQueryCo = false;

    /**
     * 是否生成PageQry
     */
    private boolean generatorPageQry = false;
