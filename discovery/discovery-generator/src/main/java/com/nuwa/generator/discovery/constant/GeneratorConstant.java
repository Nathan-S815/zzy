...
package com.nuwa.generator.discovery.constant;
...
public interface GeneratorConstant {
     ...
     * 参数qry
     */
    String PARAM_QRY = "query";

    /**
     * 分页参数
     */
    String PAGE_PARAM_QRY = "PageQry";
     ...
     * 分页参数 template路径
     */
    String PAGE_QRY_TEMPLATE_PATH = File.separator + "templates" + File.separator + "page.java.vm";


    /**
     * 分页QRY参数 template路径
     */
    String QRY_PAGE_TEMPLATE_PATH = File.separator + "templates" + File.separator + "qryPage.java.vm";
     ...
     * 查询CO template路径
     */
    String QUERY_CO_TEMPLATE_PATH = File.separator + "templates" + File.separator + "queryCo.java.vm";
     ...
     */
    String SUPER_SERVICE_CLASS = "com.nuwa.framework.database.supper.SuperService";
    /**
     * 自定义继承的ServiceImpl类全称，带包名
     */
    String SUPER_SERVICE_IMPL_CLASS = "com.nuwa.framework.database.supper.SuperServiceImpl";
    /**
     * 分页参数父类全称，带包名
     */
