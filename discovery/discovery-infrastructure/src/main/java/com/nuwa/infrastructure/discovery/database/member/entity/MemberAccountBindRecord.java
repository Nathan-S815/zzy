...
@ApiModel(value = "MemberAccountBindRecord对象")
public class MemberAccountBindRecord extends Model<MemberAccountBindRecord> {
    ...
    public static final String MEMBER_ACCOUNT_BIND_ID = "member_account_bind_id";
    ...
    public static final String REFUSE_PICTURES = "refuse_pictures";
