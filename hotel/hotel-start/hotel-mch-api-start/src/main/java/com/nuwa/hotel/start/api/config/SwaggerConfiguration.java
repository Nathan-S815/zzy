...
public class SwaggerConfiguration {
    ...
    private static final String[] controllerPath = {"com.nuwa.hotel.start.api.controller","com.nuwa.hotel.start.api.pubsystem"};
    ...
    public Docket createRestApi() {
        ...
        docket.apiInfo(apiInfo())
                ...
                .select()
                .apis(basePackage("com.nuwa.hotel.start.api.controller;com.nuwa.hotel.start.api.pubsystem;com.nuwa.hotel.start.api.alipaydata"))
