package com.nuwa.hotel.start.api;
...
@EnableLogRecord(tenant = "com.nuwa.hotel.start.api.controller")
@SpringBootApplication(scanBasePackages = {"com.nuwa", "com.alibaba.cola"})
public class UserHotelApiStartApp implements WebMvcConfigurer {
    ...
    public static void main(String[] args) {
        ...
        SpringApplication.run(UserHotelApiStartApp.class, args);
