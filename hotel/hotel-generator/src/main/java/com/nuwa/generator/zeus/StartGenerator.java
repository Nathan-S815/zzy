...
public class StartGenerator {
    ...
    public static void main(String[] args) {
        generatorEntityAndMapper("alipay_data_order_record", "id", "ps_", "alipaydata");
        generatorService("alipay_data_order_record", "id", "ps_", "alipaydata");
        //  generatorPageQryCO("notice_info", "id", "cn_", "notice");
        //generatorPage("notice_info", "id", "cn_", "notice");
    }
    ...
    private static void generatorPageQryCO(String tableName, String pkIdName, String tablePrefix, String moduleName) {
        ...
        // 设置基本信息
        generatorProperties
                .setMavenModuleName("ticket-client")
                .setParentPackage("com.nuwa.client.ticket.clientobject")
                .setMavenModuleName("ticket-client")
                .setParentPackage("com.nuwa.client.ticket.dto.clientobject")
    ...
    private static void generatorPage(String tableName, String pkIdName, String tablePrefix, String moduleName) {
        ...
        // 设置基本信息
        generatorProperties
                .setMavenModuleName("ticket-infrastructure")
                .setParentPackage("com.nuwa.infrastructure.ticket.database")
                .setPageQryPackage("com.nuwa.client.ticket.dto.clientobject")
                .setModuleName(moduleName)
                .setAuthor("huyonghack@163.com")
                .setFileOverride(true);
        ...
        generatorProperties.getProjectConfig()
                ...
                .setEntityPackage("com.nuwa.infrastructure.ticket.database." + moduleName + StringPool.DOT + GeneratorConstant.ENTITY);
    ...
    private static void generatorQryCmdExe(String tableName, String pkIdName, String tablePrefix, String moduleName) {
        ...
        // 设置基本信息
        generatorProperties
                .setMavenModuleName("ticket-app")
                .setParentPackage("com.nuwa.app.ticket.command.query")
                .setMavenModuleName("ticket-app")
                .setParentPackage("com.nuwa.app.ticket.command.query")
                .setModuleName(moduleName)
                .setAuthor("huyonghack@163.com")
