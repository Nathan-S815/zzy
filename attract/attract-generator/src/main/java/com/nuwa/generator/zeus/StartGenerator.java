...
//        generatorEntityAndMapper("invoice", "invoice_id", "ps_", "invoice");
//        generatorService("invoice", "invoice_id", "ps_", "invoice");
    }
    ...
    private static void generatorPageQryCO(String tableName, String pkIdName, String tablePrefix, String moduleName) {
        ...
        // 设置基本信息
        generatorProperties
                .setMavenModuleName("attract-client")
                .setParentPackage("com.nuwa.client.attract.clientobject")
                .setMavenModuleName("attract-client")
                .setParentPackage("com.nuwa.client.attract.dto.clientobject")
                .setModuleName(moduleName)
                .setAuthor("nanhuang @Wangxh")
    ...
    private static void generatorPage(String tableName, String pkIdName, String tablePrefix, String moduleName) {
        ...
        // 设置基本信息
        generatorProperties
                .setMavenModuleName("attract-infrastructure")
                .setParentPackage("com.nuwa.infrastructure.attract.database")
                .setPageQryPackage("com.nuwa.client.attract.dto.clientobject")
                .setModuleName(moduleName)
                .setAuthor("nanhuang @南皇")
                .setFileOverride(true);
        ...
        generatorProperties.getProjectConfig()
                ...
                .setEntityPackage("com.nuwa.infrastructure.attract.database." + moduleName + StringPool.DOT + GeneratorConstant.ENTITY);
    ...
    private static void generatorQryCmdExe(String tableName, String pkIdName, String tablePrefix, String moduleName) {
        ...
        // 设置基本信息
        generatorProperties
                .setMavenModuleName("attract-app")
                .setParentPackage("com.nuwa.app.attract.command.query")
                .setMavenModuleName("attract-app")
                .setParentPackage("com.nuwa.app.attract.command.query")
                .setModuleName(moduleName)
                .setAuthor("nanhuang @南皇")
