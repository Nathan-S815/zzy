...
public class SwaggerConfiguration {
    ...
    private static final String[] controllerPath = {"com.nuwa.attract.start.api.controller","com.nuwa.attract.start.api.pubsystem"};
    ...
    public Docket createRestApi() {
        ...
        docket.apiInfo(apiInfo())
                ...
                .select()
                .apis(basePackage("com.nuwa.attract.start.api.controller;com.nuwa.attract.start.api.pubsystem;com.nuwa.attract.start.api.alipaydata"))
