package com.nuwa.attract.start.api;
...
@EnableLogRecord(tenant = "attract")
@SpringBootApplication(scanBasePackages = {"com.nuwa", "com.alibaba.cola"})
public class MchAttractApiStartApp implements WebMvcConfigurer {
    ...
    public static void main(String[] args) {
        ...
        SpringApplication.run(MchAttractApiStartApp.class, args);
