package com.nuwa.attract.start.api.aop;
...
import com.nuwa.infrastructure.enums.ErrorEnum;
import com.nuwa.infrastructure.exception.NoLoginException;
...
public class AuthorizationAspect {
  ...
  /*    String tokenId = JWTUtil.getTokenId(token);
        ...
        userAware.setUserId(JWTUtil.getUserId(token));
        userAware.setMchId(JWTUtil.getMchId(token));
        userAware.setUserName(JWTUtil.getUsername(token));
        userAware.setMchName(JWTUtil.getMchName(token));
    ...
    @Pointcut("execution(* com.nuwa.attract.start.api.controller..*.*(..))")
