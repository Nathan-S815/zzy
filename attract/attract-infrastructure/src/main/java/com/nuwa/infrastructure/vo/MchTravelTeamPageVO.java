...
@ApiModel(value = "景区酒店端演示对象")
public class MchTravelTeamPageVO extends Model<MchTravelTeamPageVO> {
    private static final long serialVersionUID = 1L;
    @ApiModelProperty("团队id")
    private              Long teamId;

    @ApiModelProperty("团队商户关联id")
    ...
    @ApiModelProperty("团队状态 0-未提交 1-景区酒店审核中 2-景区酒店审核失败 3-文旅局审核中 4-文旅局审核成功 5-文旅局审核失败 6-自由行 7-店审核成功")
    ...
    public static MchTravelTeamPageVO toVO(TravelTeam travelTeam) {
        MchTravelTeamPageVO vo = new MchTravelTeamPageVO();
