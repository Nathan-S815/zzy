package com.nuwa.client.attract.util;
...
public class ChannelResult<T> implements Serializable {
    ...
    public ChannelResult<T> success(T t, String errMsg,String requestStr, String responseStr) {
        this.setData(t);
        this.setCode(ChannelResultCodeEnum.SUCCESS.getCode());
        this.setMsg(ChannelResultCodeEnum.SUCCESS.getMessage());
     ...
     */
    public ChannelResult<T> channelException(String code,  String message, String requestStr,
                                             String responseStr,
                                             Long costTime) {
        this.setErrMsg(errMsg);
        this.setCode(code);
